...
def getPYRP(startTime:str, endTime:str, connection: epm.EpmConnection):
#    breakpoint()
    ...
    for prefixo in prefixos:
        ...
        cols = [col for col in df_measures.columns if col.startswith(f"{prefixo}-")]
